...
('202613131242', '0000', 'user', '史堎榆', '自动化学院', '交通运输', '2026', '', '', datetime('now')),
('202613131164', '0000', 'user', '汤仁华', '自动化学院', '电子信息', '2026', '', '', datetime('now')),
('202613021028', '0000', 'user', '吴柄澍', '自动化学院', '控制科学与工程', '2026', '', '', datetime('now')),
